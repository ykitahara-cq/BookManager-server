  ...
  describe 'GET /books' do
    context 'パラメーターに問題がない場合' do
      it '書籍の一覧が取得できること' do
        ...
        get api_v1_books_path,
            params: { limit: 20, page: 1 }, headers: { Authorization: user.token }
    ...
    context 'パラメーターに問題がある場合' do
      it '書籍の一覧が取得できないこと' do
        User.find_by(id: book.user_id)
        get api_v1_books_path,
            params: { limit: 20, page: 1 }, headers: { Authorization: nil }
      ...
      it '書籍登録ができること' do
        expect do
          post api_v1_books_path,
               params: {
                 name: build_book.name,
                 image: build_book.image,
                 price: build_book.price,
                 purchase_date: build_book.purchase_date
               },
